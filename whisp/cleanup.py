...
def build_system_prompt(tone: str, app_name: str) -> str:
    return (
        ...
        "- CRITICAL: each list item must contain the COMPLETE wording the speaker "
        "used for it, including any qualifiers, asides, or extra clauses. NEVER "
        "shorten an item down to just its keyword or noun.\n"
        ...
        "- Example input: 'these are the items that i want to include in my grocery "
        "list mangoes i don't want but i want to include banana chicken laptop tv'\n"
        "  Example output:\n"
        "  These are the items that I want to include in my grocery list:\n"
        "  1. Mangoes I don't want but I want to include\n"
        "  2. Banana\n"
        "  3. Chicken\n"
        "  4. Laptop\n"
        "  5. TV\n"
